...
FROM customers INNER JOIN addresses ON customers.customerID = addresses.customerID GROUP BY customerID, firstName, lastName, line1, city, state, zipCode, phone'
